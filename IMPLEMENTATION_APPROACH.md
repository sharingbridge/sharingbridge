...
**Normative product context:** Technical and infra work in this roadmap must stay aligned with [ShareBridge_Business_Requirement.md](ShareBridge_Business_Requirement.md) — section **“Product truths & operating assumptions”**: beneficiaries are not registered users; ShareBridge does not own financial tracking responsibility (no authoritative platform ledger); pledges and community assist are **voluntary coordination** until orchestration is fully specified; privacy and unhappy paths may tighten iteratively.
