...
```powershell
curl -X POST http://localhost:8080/v1/initiator-setup/suggest-vendors `
...
curl -X POST https://<integration-host>.onrender.com/v1/donor-setup/suggest-vendors `
  -H "Content-Type: application/json" `
  -H "Authorization: Bearer <initiator-jwt>" `
...
- [AI_PLAN.md](../development/AI_PLAN.md) — architecture and provider split
