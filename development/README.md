...
**Start:** [README.md § Documentation guide](../README.md#documentation-guide) — full map and reading order.
...
| [USER_SERVICE_PREFERENCES_MIGRATION.md](./USER_SERVICE_PREFERENCES_MIGRATION.md) | File prefs → user-service |
