...
| [USER_SERVICE_PREFERENCES_MIGRATION.md](./USER_SERVICE_PREFERENCES_MIGRATION.md) | File-backed prefs → user-service cutover |
| [CALL_FOR_CONTRIBUTORS.md](./CALL_FOR_CONTRIBUTORS.md) | How to contribute |

**Run and deploy** live under [`configuration/README.md`](../configuration/README.md), not here.
